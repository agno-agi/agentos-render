...
| [`app/knowledge.py`](app/knowledge.py) | `shared_knowledge` — the one PgVector base, registry name `shared-knowledge`. Ships empty; the AgentOS UI's Knowledge page is the load path. |
